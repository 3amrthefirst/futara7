...
class HomeController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $product = Product::all();
        $client = Client::all();
        return view('admin.layouts.home',compact('line1','line2' , 'company' , 'category' , 'product' , 'client'));
    }
    ...
    private function contactsPerMonth($request)
    {
        ...
        $contactsMonthly
            ...
            ->dataset('عدد الفواتير شهريا','line',$contacts->pluck('total_contacts')->toArray())
