...
Route::group(['middleware' => ['auth:admin']], function () {
    ...
    Route::resource('subscription', 'JoinRequestController');
    Route::get('subscription-details/{id}', 'JoinRequestController@details')->name('subscription-details');
    ...
    //products
    Route::get('products/{id}' , [CompanyController::class , 'products'])->name('category.products');
